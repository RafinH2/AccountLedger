...
/// <summary>
/// Доменная модель транзакции списания.
/// </summary>
public sealed class DebitTransaction : ITransaction
{
    private DebitTransaction(Guid id, Guid clientId, DateTime occurredAtUtc, decimal amount)
    {
        Id = id;
        ClientId = clientId;
    ...
    /// <summary>
    /// Создает и валидирует транзакцию списания.
    /// </summary>
    /// <param name="id">Идентификатор транзакции.</param>
    /// <param name="clientId">Идентификатор клиента.</param>
    /// <param name="occurredAt">Время возникновения транзакции.</param>
    /// <param name="amount">Сумма транзакции.</param>
    /// <returns>Экземпляр валидной транзакции списания.</returns>
    public static DebitTransaction Create(
        Guid id,
        Guid clientId,
        ...
        decimal amount)
    {
        ...
        return new DebitTransaction(id, clientId, occurredAt.UtcDateTime, amount);
    }
